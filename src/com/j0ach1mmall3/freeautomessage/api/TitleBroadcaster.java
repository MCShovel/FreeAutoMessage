...
public final class TitleBroadcaster extends PlayerBroadcaster {
    ...
    public TitleBroadcaster(String identifier, boolean random, int interval, List<String> messages, List<String> enabledWorlds, String permission, int fadeIn, int stay, int fadeOut) {
