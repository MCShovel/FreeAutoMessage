...
public class SubtitleBroadcaster implements Broadcaster {
    ...
    public void broadcast() {
        ...
        for(Player p : Bukkit.getOnlinePlayers()) {
            if(p.hasPermission(this.permission) && this.enabledWorlds.contains(p.getWorld().getName())) new Subtitle(p, this.messages.get(id), this.fadeIn, this.stay, this.fadeOut).send();
        }
    }
}
