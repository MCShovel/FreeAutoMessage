 ...
 * @since 18/08/2015
 */
public class SubtitleBroadcaster implements Broadcaster {
    ...
    public void broadcast() {
        ...
        Bukkit.getOnlinePlayers().stream().filter(p -> p.hasPermission(this.permission) && this.enabledWorlds.contains(p.getWorld().getName())).forEach(p -> new Subtitle(p, this.messages.get(id), this.fadeIn, this.stay, this.fadeOut).send());
    }
}
