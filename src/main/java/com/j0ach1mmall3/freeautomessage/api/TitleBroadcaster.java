 ...
 * @since 18/08/2015
 */
public final class TitleBroadcaster extends PlayerBroadcaster {
    private final int fadeIn;
    private final int stay;
    private final int fadeOut;

    public TitleBroadcaster(Main plugin, String identifier, boolean random, int interval, List<String> messages, List<String> enabledWorlds, String permission, int fadeIn, int stay, int fadeOut) {
