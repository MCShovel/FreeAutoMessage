...
public final class TitleBroadcaster extends WorldsBroadcaster {
    ...
    public TitleBroadcaster(String identifier, boolean random, int interval, List<String> messages, String permission, List<String> enabledWorlds, int fadeIn, int stay, int fadeOut) {
